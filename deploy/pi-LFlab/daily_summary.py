...
To set up cron (run `crontab -e` on the Pi and add):
    5 0 * * * /usr/bin/python3 /home/pi_24/prusa-agent/daily_summary.py >> /home/pi_24/prusa-agent/daily_summary.log 2>&1
...
def run(target_date=None):
    ...
    for machine_id, name in machines:
        ...
        # Convert log counts to minutes (each log = one poll interval)
